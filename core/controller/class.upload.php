...
class upload {
    ...
    function getsize($size) {
        ...
        switch($last) {
            case 'g':
                $size *= 1024;
				//la verdad no se que pedo con esta onda ya que esto es lo que me muestra el error de no subir archivos 
				//de otro formato
				// pero en el caso de las img png y mp3 y todos los demas pinches archivos si se suben ya veras
				
				
                Core::alert("Solo puedes subir archivos PDF!");
