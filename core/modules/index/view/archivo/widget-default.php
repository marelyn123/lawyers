...
<div class="col-md-12">
<ol class="breadcrumb">
<li><a href="./?view=home"><i class="fa fa-home"></i> Inicio </a><a> / </a> <a href="./?view=archivo"><i class="fa fa-file-text"></i> Mis Archivos </a></li>
	<?php
	if($folder!=null){
	    echo '<li><a href="./?view=archivo&folder='.$folder->code.'"><i class="fa fa-folder-open"></i> '.$folder->filename.'</a></li>';
	}
	?>
...
<?php if($folder==null):?>
	<center><h3>Mis Archivos</h3></center>
<?php else:?>
...
<tr>
	...
	<a href="./?view=archivo&folder=<?php echo $file->code;?>">
	...
	<td style="width:223px;">
		...
		<a target="blank" href="./?action=ver&code=<?php echo $file->code;?>" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> Ver</a>
